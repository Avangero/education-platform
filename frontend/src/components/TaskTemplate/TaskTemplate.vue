<template>
  <div v-if="!getLoading" class="task-template">
    <Textarea v-model="templateTitle" autoResize class="task-template__title" />
    <Editor
    ...
    templateContent: {
      ...
      set(value) {
        return this.$store.commit(
          'tasksTemplates/CHANGE_TASK_TEMPLATE_CONTENT',
          {
            value: value,
            taskTemplateId: this.taskId
          }
